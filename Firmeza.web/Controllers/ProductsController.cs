...
namespace Firmeza.web.Features.Products.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString, string categoryFilter)
        {
            ...
            ViewBag.Categories = (await _getProductsQuery.GetAllProductsAsync())
                .Select(p => p.Category)
                .Distinct()
                .OrderBy(c => c)
                .ToList();
        ...
        public async Task<IActionResult> Edit(int id, UpdateProductDto dto)
        {
            ...
            var product = await _getProductsQuery.GetProductByIdAsync(id);
            return View(product);
        }
        ...
        public async Task<IActionResult> ExportToPdf()
        {
            ...
            {
                var products = await _getProductsQuery.GetAllProductsAsync();
                var pdfBytes = await _pdfService.GenerateProductListPdfAsync(products);
